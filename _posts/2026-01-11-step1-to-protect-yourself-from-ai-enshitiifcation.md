...
A decade ago, Cryptography expert Bruce Schneier wrote 'Data & Goliath' and made the point that corporate surveillance is far greater than government surveillance even when he was one of the key people collaborating with Glen Greenwald to analyse the NSA files Edward Snowden leaked. The concern, he mentions is that institutions, both public and private are teaming up on surveillance instead of ramping up on security. Known vulnerabilities are left in systems to be able to spy onto others rather than create an environment where everyone gets more secure. In light of this, the new AI developed systems are generating code that is hard to comprehend for humans and it is a high likelihood that critical oversight will be missed as we get more used to them. While these AI capabilities are improving, the mantra 'They work most of the times' doesn't work for securing our data as the chain is strongest as the weakest link in the chain. 